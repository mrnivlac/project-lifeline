...
export default {
  ...
  createDefaultPatientConfig(patientId) {
    const defaultConfig = {
      ...
      heartrate_lower_bpm: 60,
      pulserate_upper_bpm: 100,
      pulserate_lower_bpm: 60,
      oxygen_upper_saturation: 100,
      oxygen_lower_saturation: 94,
      respiratory_upper_rpm: 20,
      respiratory_lower_rpm: 12,
      bp_systolic_upper: 140,
      bp_systolic_lower: 100,
      bp_diastolic_upper: 90,
      bp_diastolic_lower: 60,
      bp_time_frame: 60,
      temperature_upper: 37.8,
      temperature_lower: 36.5,
    };
